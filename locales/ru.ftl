...
picture_text =✍️ Отправьте свою фотографию сделанную в фотостудии в формате Green Card(6x6)!

picture_error_text =⚠️ Введена неверная информация!

     <i>✍️ Отправьте свою фотографию сделанную в фотостудии в формате Green Card(6x6)!</i>
...
child_picture_text =  {$number} - Присылайте фотографию вашего ребенка в формате Green Card (6х6), сделанную в фотостудии!

child_picture_error_text = ⚠️ Введена неверная информаци

      <i> {$number} - Присылайте фотографию вашего ребенка в формате Green Card (6х6), сделанную в фотостудии!</i>
...
hw_picture_text =✍️ Отправьте фотографию мужа/жены, сделанную в фотостудии, в формате Green Card (6х6)!

hw_picture_error_text =⚠️ Введена неверная информаци

     <i>✍️ Отправьте фотографию мужа/жены, сделанную в фотостудии, в формате Green Card (6х6)!</i>
...
payment_ticket_text = ✅ Ваша заявка на <b>Green card</b> принята.
    ...
    📨 Номер заявки: <b>{$order_number}</b>
      ...
      <i>💳 Номер карты: <code>{$card_number}</code></i>
...
contact_phone_text = <b>Контактные номера</b>
      ...
      <i>☎️ Колл-центр: <b>  +998 (99) 770-00-27</b></i>
      <i>☎️ Дополнительный номер: <b> +998 (90) 353-44-43</b></i>
...
success_check_text = <b> ✅ Чек об оплате отправлена ​​на рассмотрение администратору!</b>

     <i>Ответ о регистрации анкеты вам будет отправлен в течение 24 часов</i>
...
confirmation_picture_text = <b>✅ Зарегистрировано</b>
